...
function ajax_comment_scripts(){
    wp_enqueue_style( 'ajax-comment', get_template_directory_uri() . '/includes/ajax-comment.css', array(), '20150223' );
    wp_enqueue_script( 'ajax-comment', get_template_directory_uri() . '/includes/ajax-comment.js', array( 'jquery' ), '20150223', true );
...
<li <?php comment_class(); ?>">
   <div class="comment-body">  
	...
	<div class="italk">
    <span class="comment-span"><?php comment_author_link() ?></span>
    <?php if ( $comment->comment_approved == '0' ) : ?>
        ...
        <div class="clear"></div>
<span class="datetime"><?php echo time_since(abs(strtotime($comment->comment_date_gmt . "GMT")), true);?> </span>
	</div>
  </div>
    </li>
    <?php die();
